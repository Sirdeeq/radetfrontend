...
export default function Page() {
  ...
  if (isAuthenticated) {
    return <Navigate to={DEFAULTS.appRoot} replace />;
  }
            ...
            <Box className="flex flex-col gap-10">
              ...
              <Box className="flex flex-col gap-5">
                ...
                >
                  ...
                  {loginError && (
                    <Alert severity="error" className="neutral mb-4">
                      <AlertTitle variant="subtitle2">Login Failed</AlertTitle>
                      <Typography variant="body2">{loginError}</Typography>
                    </Alert>
                  )}
                  {submitted && !formik.isValid && !loginError && (
              ...
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-secondary">
                  New to RADET? Please use your email to{" "}
