            ...
            <Box className="flex flex-col gap-10">
              <Box className="flex flex-col">
                ...
                <Typography variant="body1" className="text-text-primary">
                  Welcome to RADET! These terms and conditions outline the rules and regulations for the use of RADET.
                  By accessing this website we assume you accept these terms and conditions. Do not continue to use
                  RADET if you do not agree to all of the terms and conditions stated on this page.
                </Typography>
              </Box>
              ...
              <Box>
                ...
                <Typography variant="body1">
                  These Terms and Conditions govern your use of the RADET platform. By accessing or using our services,
                ...
                <Typography variant="body1">
                  Other than the content you own, under these Terms, RADET and/or its licensors own all the intellectual
                ...
                <Typography variant="body1">
                  This Website is provided "as is," with all faults, and RADET expresses no representations or
                  warranties.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  In no event shall RADET, nor any of its officers, directors and employees, be held liable for anything
                ...
                <Typography variant="body1">
                  You hereby indemnify to the fullest extent RADET from and against any and all liabilities, costs,
                ...
                <Typography variant="body1">
                  RADET is permitted to revise these Terms at any time as it sees fit.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms constitute the entire agreement between RADET and you.
                </Typography>
                <br />
                ...
                <Typography variant="body1">
                  These Terms will be governed by and interpreted in accordance with the applicable laws, and you submit
                  to the non-exclusive jurisdiction of the relevant courts.
                </Typography>
              </Box>
            </Box>
          </Box>
